...
!  This module adds 7 carbon pools for 13C 
!
!  Alexandra Jahn, NCAR, Started Nov 2012
!  Removed 14C July 2017
!
! !REVISION HISTORY:
...
!-----------------------------------------------------------------------
   ...
   do auto_ind = 1, autotroph_cnt
      ...
      if (autotrophs(auto_ind)%imp_calcifier .or. &
          autotrophs(auto_ind)%exp_calcifier) n = n + 1 ! Ca13CO3  tracers
   end do
...
! !DESCRIPTION:
!  Compute time derivatives for 13C  state variables.
!
! !REVISION HISTORY:
!  13C code is based on code from X. Giraud, ETH Zürich, 2008, for pop1
!  Adapted to pop2 and new ecosystem model code
...
!-----------------------------------------------------------------------
!     Small phytoplankton, Diatom, and
!     Diaztroph 13C fixation
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!   Calculate oceanic D13C of carbon pools
!-----------------------------------------------------------------------
